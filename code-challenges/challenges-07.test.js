...
const listFoods = (recipe) => {
 ...
 {
 LastSpace = (recipe.ingredients[i].indexOf(' ',3)) //after how much and what is it.

 itemName =recipe.ingredients[i].slice(LastSpace+1) //after find the space  by one
...
const splitFoods = (recipe) => {
 ...
 for(let i = 0 ; i < ingredientsLength ;i++)
 {
 LastSpace = (recipe.ingredients[i].split(' '))
