...
Write a function named `addExclamation` that
 takes an array of strings, and returns a new 
 array of the same strings with an "!" added to the end.
...
Write a function named `allUpperCase` 
that takes an array of strings, and returns
 a new array of the strings converted to upper case.
...
const speaker = (words, callback) => {
  ...
  words.forEach( (item) => {
   let modifiedElement= callback(item)
tempArr.push(modifiedElement)
  });
